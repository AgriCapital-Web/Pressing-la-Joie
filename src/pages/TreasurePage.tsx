...
import leveTopoVideo from "@/assets/leve-topo.mp4.asset.json";
import leveTopoPoster from "@/assets/leve-topo-poster.webp.asset.json";
      ...
      <main>
        <section className="relative flex min-h-screen items-center justify-center overflow-hidden pt-20">
          ...
          <div className="container relative mx-auto px-4 py-24 text-center text-primary-foreground">
            <p className="mb-4 text-sm font-black uppercase tracking-[0.25em] text-[#f6d47a] drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">Le trésor caché</p>
